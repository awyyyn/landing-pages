...
const Footer = () => {
    ...
    return (
        <footer className="lg:px-[160px] pt-[97px] pb-[64px] w-full  ">
            <div className="flex  justify-between md:max-w-[756px] mx-auto lg:max-w-[1056px] lg:gap-x-[760px] gap-y-[60px] px-[32px]">
            ...
            <div className="flex px-[32px] justify-between  md:px-0 flex-col sm:flex-row md:max-w-[756px] mx-auto gap-y-[20px] mt-[30px] md:mt-[60px] lg:max-w-[1056px] lg:gap-x-[760px]"> 
