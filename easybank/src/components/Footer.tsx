...
export default function Footer() {
    ...
    return (
        <footer className='padding col-to-row footer-util flex-wrap '>    
            <div className='col-to-row laptop:gap-x-10 widescreen:gap-x-20 gap-y-5'>
                <div className='flex flex-col gap-y-7 justify-between items-center'>
                    <img src={logo} alt='Easybank Logo' className='object-contain h-5 ' />
                    <div className='flex scale-125 laptop:scale-100 gap-x-3'>
                ...
                <div className='col-to-row footer-links'>
                    <div className='space-y-2 center-to-left-text'>
            ...
            <div className='space-y-5 text-center laptop:text-end'>
